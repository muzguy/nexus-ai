    ...
    <div className="p-4 sm:p-6 lg:p-8 space-y-6 sm:space-y-8 max-w-7xl mx-auto w-full box-border">
      ...
      <div className="p-4 sm:p-5 rounded-xl bg-nexus-900 border border-nexus-800 flex flex-col sm:flex-row sm:items-center justify-between gap-4 shadow-xs">
        <div className="flex items-start gap-3.5">
          <div className="w-9 h-9 rounded-lg bg-rose-500/10 border border-rose-500/25 flex items-center justify-center shrink-0 text-rose-400 mt-0.5 sm:mt-0">
            <Crosshair className="w-5 h-5" />
          </div>
          <div className="flex-1 min-w-0">
            <div className="flex items-center gap-2 mb-1 flex-wrap">
              <h3 className="text-xs font-mono font-semibold text-rose-400 uppercase tracking-wider">
          ...
          return (
            <Card
              ...
              className={`flex flex-col h-full border ${
                isSelected ? 'border-rose-600/50 ring-1 ring-rose-500/30 bg-rose-950/15 shadow-xs' : 'border-nexus-800'
              }`}
            >
