...
export function EmptyState({
  ...
  return (
    <div
      className={cn(
        'flex flex-col items-center justify-center p-8 sm:p-14 text-center rounded-2xl border border-nexus-800 bg-nexus-900/90 backdrop-blur-md shadow-md max-w-2xl mx-auto my-6 sm:my-8 w-full box-border relative overflow-hidden',
        className
      )}
    >
      ...
      <div className="w-12 h-12 sm:w-14 sm:h-14 rounded-xl bg-nexus-850/80 border border-nexus-800 flex items-center justify-center mb-4 shadow-xs shrink-0 text-rose-400 ring-1 ring-rose-500/20">
        {icon}
      </div>
